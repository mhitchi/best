        ...
        <div className= "container case-studies-page">
            <div className="text-zone anim">
                ...
                <div className="wheel">
                  ...
                  <h3 className="second  thick-outline wheel-child">Looking to <span className="color-text">design</span> and<br></br>
                    <span className="color-text">build out</span> an <span className="color-text">interior space?</span>
                  </h3>
                  <h3 className="third thick-outline wheel-child">Have an idea for <br></br>
                    a <span className="color-text">product?</span>
                  </h3>
                  <h3 className="fourth thick-outline wheel-child">Need a <span className="color-text">scale model</span> for an<br></br>
                    <span className="color-text">architecture project?</span>
                  </h3>
                  <h3 className="fifth thick-outline wheel-child">Want a custom <br></br>
